  ...
  },
  {
    ...
    menu: [
      ...
      },
      {
        ...
        hasSubRoute: false,
        showSubRoute: false,
        route: routes.adminCategoriesList,
      ...
      },
      {
        ...
        hasSubRoute: false,
        showSubRoute: false,
        route: routes.adminSubCategories,
    ...
    menu: [
      {
        ...
        hasSubRoute: false,
        showSubRoute: false,
        route: routes.adminBankTransferList,
      ...
      },
      {
        ...
        hasSubRoute: false,
        showSubRoute: false,
        route: routes.adminRefundRequest,
      ...
      },
      {
        ...
        hasSubRoute: false,
        showSubRoute: false,
        route: routes.adminCashOnDelivery,
        ...
        subMenus: [
          {
            ...
            route: routes.adminPayoutRequest,
          },
          {
            menuValue: 'Payout Settings',
            route: routes.adminPayoutSettings,
          },
        ],
      },
      {
        ...
        hasSubRoute: false,
        showSubRoute: false,
        route: routes.adminSalestransactions,
    ...
    menu: [
      {
        ...
        subMenus: [
          {
            menuValue: 'Add Page',
            route: routes.adminAddPages,
          },
          {
            menuValue: 'Pages',
            route: routes.adminPagesList,
          },
          {
            menuValue: 'Pages List',
            route: routes.adminPageList,
          },
        ],
      },
      {
        ...
        subMenus: [
          ...
          {
            menuValue: 'Categories',
            route: routes.adminBlogsCategories,
          },
          {
            menuValue: 'Blog Comments',
            route: routes.adminBlogComments,
          },
        ],
      },
      {
        ...
        subMenus: [
          {
            menuValue: 'Countries',
            route: routes.adminCountries,
          },
          {
            menuValue: 'States',
            route: routes.adminState,
          },
          {
            menuValue: 'Cities',
            route: routes.adminCities,
          },
        ],
      },
      {
  ...
  },
  {
    ...
    menu: [
      ...
      },
      {
        ...
        hasSubRoute: false,
        showSubRoute: false,
        route: routes.adminMembershipaddons,
  ...
  },
  {
    ...
    menu: [
      ...
      },
      {
        ...
        hasSubRoute: false,
        showSubRoute: false,
        route: routes.adminMembershipTransaction,
