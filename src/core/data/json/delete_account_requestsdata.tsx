export const DeleteAccountrequestsdata = [
  {
    ...
    customer: 'assets/admin/img/customer/user-01.jpg',
    content: 'Confirm',
  ...
  },
  {
    ...
    customer: 'assets/admin/img/customer/user-07.jpg',
    content: 'Confirm',
    customerName: 'Johnny',
  ...
  },
  {
    ...
    customer: 'assets/admin/img/customer/user-09.jpg',
    content: 'Confirm',
    customerName: 'Robert',
  ...
  },
  {
    ...
    customer: 'assets/admin/img/customer/user-06.jpg',
    content: 'Confirm',
  ...
  },
  {
    ...
    customer: 'assets/admin/img/customer/user-04.jpg',
    content: 'Confirm',
