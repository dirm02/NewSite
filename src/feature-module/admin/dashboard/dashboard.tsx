...
import { adminDashboard3Data } from '../../../core/data/json/admin-dashboard3';
import { adminDashboard2Data } from '../../../core/data/json/admin-dashboard2';
import { adminDashboard1Data } from '../../../core/data/json/admin-dashboard1';
...
const AdminDashboard = () => {
  ...
  const data1 = adminDashboard1Data
  const data2 = adminDashboard2Data
  const data3 = adminDashboard3Data
  ...
  const chartSeries = [
    ...
    // Uncomment and provide data if needed
    // {
    //   name: 'Revenue',
              ...
              <div className="card-body">
                <div className="home-user">
                  <div className="home-head-user home-graph-header">
                    <h2>Top Services</h2>
                    <Link to={routes.adminAllServices} className="btn btn-viewall">
                      View All
                      <ImageWithBasePath
              ...
              <div className="card-body">
                <div className="home-user">
                  <div className="home-head-user home-graph-header">
                    ...
                    <Link to={routes.booking1} className="btn btn-viewall">
                      View All
                      <ImageWithBasePath
                        src="assets/admin/img/icons/arrow-right.svg"
                        className="ms-2"
