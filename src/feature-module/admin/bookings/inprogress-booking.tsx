...
import type { InprogressBookingInterface } from '../../../core/models/interface';
import { inProgressBookingData } from '../../../core/data/json/inprogress-booking';

const InprogressBooking = () => {
  const [selectedValue, setSelectedValue] = useState(null);
  const value = [{ name: 'A - Z' }, { name: 'Z - A' }];
  const routes = all_routes;
  const data = inProgressBookingData;
  const serviceImage = (rowData: InprogressBookingInterface) => {
  ...
  const providerImage = (rowData: InprogressBookingInterface) => {
  ...
  const userImage = (rowData:InprogressBookingInterface) => {
  ...
  const statusButton = (rowData:InprogressBookingInterface) => {
          ...
          <div className="col-12">
            <div className="tab-sets">
              <div className="tab-contents-sets">
                <ul>
                  <li>
                    <Link to={routes.adminBooking}>All Booking</Link>
                  </li>
                  <li>
                    <Link to={routes.adminPendingBooking}>Pending </Link>
                  </li>
                  <li>
                    <Link to={routes.adminInProgressBooking} className="active">
                      Inprogress{' '}
                    </Link>
                  </li>
                  <li>
                    <Link to={routes.adminCompletedBooking}>Completed </Link>
                  </li>
                  <li>
                    <Link to={routes.adminCancelledBooking}>Cancelled</Link>
                  </li>
                </ul>
              </div>
