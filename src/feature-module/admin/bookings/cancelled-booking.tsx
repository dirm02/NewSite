...
import type { CancelledBookingInterface } from '../../../core/models/interface';
import { CancelledData } from '../../../core/data/json/cancelled_booking';
              ...
              <div className="tab-sets">
                <div className="tab-contents-sets">
                  <ul>
                    ...
                    <li>
                      <Link to={routes.adminCancelledBooking} className="active">
                        Cancelled
                      </Link>
                    </li>
                  </ul>
