...
import type { PendingBookinginterface } from '../../../core/models/interface';
                            ...
                            <div className="tab-sets">
                                <div className="tab-contents-sets">
                                    <ul>
                                        ...
                                        <li>
                                            <Link to={routes.adminPendingBooking} className="active">Pending </Link>
                                        </li>
                                        <li>
                                            <Link to={routes.adminInProgressBooking}>Inprogress </Link>
                                        </li>
                                        <li>
                                            <Link to={routes.adminCompletedBooking} >
                                                Completed
                                            </Link>
                                        </li>
                                        <li>
