...
import type { CompletedBookingInterface } from '../../../core/models/interface';
import { bookingCompletedData } from '../../../core/data/json/booking-completed';
...
const CompletedBooking = () => {
  ...
  const data = bookingCompletedData;
              ...
              <div className="tab-sets">
                <div className="tab-contents-sets">
                  <ul>
                    ...
                    <li>
                      <Link to={routes.adminInProgressBooking}>Inprogress </Link>
                    </li>
                    <li>
                      <Link to={routes.adminCompletedBooking} className="active">
                        Completed
                      </Link>
                    </li>
                    <li>
