            ...
            <div className="tab-sets mb-4">
              <div className="tab-contents-sets">
                <ul>
                  ...
                  <li>
                    <Link to={routes.adminPendingBlog}>Pending Blog</Link>
                  </li>
                  <li>
                    <Link to={routes.adminInActiveBlog} className="active">
                      Inactive Blog
                    </Link>
                  </li>
                </ul>
            ...
            <div className="blog grid-blog">
              ...
              <div className="blog-content">
                ...
                <div className="blog-info">
                  ...
                  <span>
                    <Icon.AlertCircle className="react-feather-custom" /> Active
                  </span>
                </div>
              </div>
            </div>
