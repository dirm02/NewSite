            ...
            <div className="col-12">
              <div className="tab-sets mb-4">
                <div className="tab-contents-sets">
                  <ul>
                    <li>
                      <Link to={routes.adminAllBlog}>Active Blog</Link>
                    </li>
                    <li>
                      <Link to={routes.adminPendingBlog} className="active">
                        Pending Blog
                      </Link>
                    </li>
                    <li>
                      <Link to={routes.adminInActiveBlog}>Inactive Blog</Link>
                    </li>
                  </ul>
                </div>
            ...
            <div className="col-lg-4 col-sm-6 col-12">
              <div className="blog grid-blog">
                <div className="blog-image">
                  ...
                  <div className="fav-item">
                    <div className="item-info">
                      <Link to={routes.adminCategoriesList}>
                ...
                <div className="blog-content">
                  ...
                  <p>
                    Sed perspiciatis unde omnis natus error laudantium, totam
                    rem aperiam...
                  </p>
                  <div className="blog-info">
                    <div className="action-search">
                      <Link to={routes.adminEditblog} className="serv-edit">
                        <Icon.Edit className="react-feather-custom me-2" />
                        Edit
                      </Link>
                      <Link to="#">
                        <Icon.Trash2 className="react-feather-custom me-2" />
                        Delete
                      </Link>
                    </div>
                    <span>
                      <Icon.AlertCircle className="react-feather-custom me-2" />
                      Pending
                    </span>
                  </div>
                </div>
              ...
              <div className="blog grid-blog">
                ...
                <div className="blog-content">
                  <div className="blog-widget-image">
                    ...
                    <h6>
                      <ImageWithBasePath
                        src="/aassets/admin/img/icons/calendar.svg"
                        alt="img"
                      />
                      28 Sep 2023
                    </h6>
