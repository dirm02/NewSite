...
import type { SalesTransactiondatas } from '../../../core/models/interface';
import { SalesTransactionsData } from '../../../core/data/json/sales_transactionsdata';

const SalesTransactions = () => {
  const data = SalesTransactionsData;
    ...
    return (
      <div className="table-namesplit">
        <Link to="#" className="table-profileimage">
          <ImageWithBasePath src={data.customer1.image} className="me-2" alt="img" />
        </Link>
  ...
  const providerName = (data: SalesTransactiondatas) => {
    return (
      <div className="table-namesplit">
        <Link to="#" className="table-profileimage">
          <ImageWithBasePath src={data.customer2.image} className="me-2" alt="img" />
        </Link>
        <Link to="#" className="table-name">
    ...
    return (
      <div>
        <Link to="#" className="table-imgname">
          <ImageWithBasePath src={data.service.image} className="me-2" alt="img" />
