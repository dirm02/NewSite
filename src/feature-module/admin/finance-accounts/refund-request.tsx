...
import type { RefundRequestdatas } from '../../../core/models/interface';
import { RefundRequestData } from '../../../core/data/json/refund_requestsdata';

const RefundRequest = () => {
  const data = RefundRequestData;
  ...
  const userName = (data: RefundRequestdatas) => {
    return (
      <div>
        <Link to="#" className="table-profileimage">
          <ImageWithBasePath src={data.customer1} className="me-2" alt="img" />
  ...
  const serviceName = (data: RefundRequestdatas) => {
    return (
      <div>
        <Link to="#" className="table-profileimage">
          <ImageWithBasePath src={data.profile} className="me-2" alt="img" />
