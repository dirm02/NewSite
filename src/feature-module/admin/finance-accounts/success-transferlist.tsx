...
import { successfulTransferlistData } from "../../../core/data/json/successfull-transferlist";
...
const SuccessTransferlist = () => {
  ...
  const data = successfulTransferlistData;
              ...
              <div className="tab-sets">
                <div className="tab-contents-sets">
                  <ul>
                    ...
                    <li>
                      <Link to={routes.adminApprovedTransferlist}>
                        Approved{" "}
                      </Link>
                    </li>
                    <li>
                      <Link to={routes.adminPendingTransferlist}>
                        Pending{" "}
                      </Link>
                    </li>
                    <li>
                      <Link
                        to={routes.adminSuccessTransferlist}
                        className="active"
                      >
                        Successful{" "}
                      </Link>
                    ...
                    <li>
                      <Link to={routes.adminRejectedTransferlist}>
                        Rejected lists
                      </Link>
                    </li>
                  </ul>
