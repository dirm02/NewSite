...
import type { ActiveserviceInterface } from '../../../core/models/interface';
          ...
          <div className="content-page-header content-page-headersplit">
            ...
            <div className="list-btn">
              <ul>
                ...
                <li>
                  <Link className="btn btn-primary" to={all_routes.adminAddServices}>
            ...
            <div className="col-12">
              <div className="tab-sets">
                <div className="tab-contents-sets">
                  <ul>
                    <li>
                      <Link to={all_routes.adminAllServices}>All Services</Link>
                    </li>
                    <li>
                      <Link to={routes.adminActiveServices} className="active">
                        Active
                      </Link>
                    </li>
                    <li>
                      <Link to={routes.adminPendingServices}>Pending </Link>
                    </li>
                    <li>
                      <Link to={routes.adminInActiveServices}>Inactive </Link>
                    </li>
                    <li>
                      <Link to={routes.adminDeletedServices}>Deleted </Link>
                    </li>
                  </ul>
                </div>
