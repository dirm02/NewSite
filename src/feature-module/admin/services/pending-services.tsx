                            ...
                            <div className="tab-sets">
                                <div className="tab-contents-sets">
                                    <ul>
                                        ...
                                        <li>
                                            <Link to={all_routes.adminActiveServices}>Active</Link>
                                        </li>
                                        <li>
                                            <Link to={all_routes.adminPendingServices} className="active">
                                                Pending
                                            </Link>
                                        </li>
                                        <li>
                                            <Link to={all_routes.adminInActiveServices}>Inactive </Link>
                                        </li>
                                        <li>
                                            <Link to={all_routes.adminDeletedServices}>Deleted </Link>
                                        </li>
                                    </ul>
                                </div>
