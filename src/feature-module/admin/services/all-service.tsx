...
import type { AllserviceInterface } from '../../../core/models/interface';
  ...
  const renderBody3 = () => {
    return (
      <div className="action-language">
        <Link className="table-edit" to={all_routes.adminEditService}>
              ...
              <ul>
                ...
                <li>
                  <Link
                    ...
                    to={all_routes.adminAddServices}
                  >
              ...
              <div className="tab-sets">
                <div className="tab-contents-sets">
                  <ul>
                    ...
                    <li>
                      <Link to={routes.adminActiveServices}>Active</Link>
                    </li>
                    <li>
