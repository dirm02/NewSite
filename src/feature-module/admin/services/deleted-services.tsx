...
import type { deletedServices } from '../../../core/models/interface';
...
const DeletedServices = () => {
  ...
  const handleButtonClick = () => {
    navigate(routes.adminAddServices);
  };
            ...
            <div className="col-12">
              <div className="tab-sets">
                <div className="tab-contents-sets">
                  <ul>
                    <li>
                      <Link to={routes.adminAllServices}>All Services</Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link to={routes.adminDeletedServices} className="active">
                        Deleted
                      </Link>
                    </li>
                  </ul>
