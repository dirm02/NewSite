          ...
          <div className="row">
            <div className="col-xl-8">
              ...
              <div className="service-images big-gallery">
                      <ImageWithBasePath
                        src="assets/admin/img/services/service-ban-01.jpg"
                        className="img-fluid"
                        alt="img"
                      />
                      <Link
                        to="assets/admin/img/services/service-ban-01.jpg"
                      ...
                      <Lightbox
                        ...
                        slides={[
                          { src: '/assets/admin/img/services/service-ban-01.jpg' },
                          { src: '/assets/admin/img/services/service-ban-02.jpg' },
                          { src: '/assets/admin/img/services/service-ban-03.jpg' },
                        ]}
                      />
                    </div>
                  ...
                  <div className="service-widget aos" data-aos="fade-up">
                    <div className="service-img">
                      <ImageWithBasePath
                        className="img-fluid serv-img"
                        alt="Service Image"
                        src="assets/admin/img/services/service-02.jpg"
                      />
