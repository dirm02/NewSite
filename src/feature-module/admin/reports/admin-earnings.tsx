...
const AdminEarnings = () => {
  ...
  const statusButton = (rowData : any) => {
    ...
    return (
      <h6 className="badge-active completed-active-badge">{status}</h6>
    );
  };
  ...
  const data = useSelector((state: any) => state.admin_earnings);
            ...
            <div className="table-resposnive table-div">
              <table className="table datatable">
                ...
                >
                  ...
                  <Column sortable field="service" header="Service" body={serviceImage}></Column>
