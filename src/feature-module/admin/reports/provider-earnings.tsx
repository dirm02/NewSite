...
const AdminProviderEarnings = () => {
  ...
  const statusButton = (rowData: any) => {
    ...
    return <h6 className="badge-active completed-active-badge">{status}</h6>;
  };
  ...
  const data = useSelector((state: any) => state.provider_earnings_admin);
  return (
              ...
              <table className="table datatable">
                ...
                >
                  ...
                  <Column
                    ...
                    body={serviceImage}
                  ></Column>
                  <Column sortable field="user" header="User"></Column>
                  <Column
                    sortable
                    field="paymentType"
                    header="Payment Type"
...
export default AdminProviderEarnings;
