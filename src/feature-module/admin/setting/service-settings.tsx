              ...
              <div className="card-body">
                ...
                <div className="location-set">
                  <div className="row align-items-center">
                    <div className="col-lg-8 col-12">
                      <div className="service-detail-blk">
                        <span><ImageWithBasePath src="assets/admin/img/icons/service-icon-06.svg" alt="Icon" /></span>
                        <div className="location-setcontent">
                ...
                <div className="location-set">
                  <div className="row align-items-center">
                    <div className="col-lg-8 col-12">
                      <div className="service-detail-blk">
                        <span><ImageWithBasePath src="assets/admin/img/icons/service-icon-07.svg" alt="Icon" /></span>
                        <div className="location-setcontent">
                ...
                <div className="location-set mb-0">
                  <div className="row align-items-center">
                    <div className="col-lg-8 col-12">
                      <div className="service-detail-blk">
                        <span><ImageWithBasePath src="assets/admin/img/icons/service-icon-08.svg" alt="Icon" /></span>
                        <div className="location-setcontent">
