          ...
          <div className="row">
            <div className="col-12">
              <div className="connectetapps">
                <div className="connectetappsimg">
                  <div className="connectet-img">
                    <img src="/assets/admin/img/icons/lock.svg" alt="img" />
                  </div>
              ...
              <div className="connectetapps">
                <div className="connectetappsimg">
                  <div className="connectet-img">
                    <img src="/assets/admin/img/icons/scan.svg" alt="img" />
                  </div>
                  <div className="connectet-content">
              ...
              <div className="connectetapps">
                <div className="connectetappsimg">
                  <div className="connectet-img">
                    <img src="/assets/admin/img/icons/mobile.svg" alt="img" />
                  </div>
                  <div className="connectet-content">
              ...
              <div className="connectetapps">
                <div className="connectetappsimg">
                  <div className="connectet-img">
                    <img src="/assets/admin/img/icons/email.svg" alt="img" />
                  </div>
                  <div className="connectet-content">
              ...
              <div className="connectetapps">
                <div className="connectetappsimg">
                  <div className="connectet-img">
                    <img src="/assets/admin/img/icons/monitor.svg" alt="img" />
                  </div>
                  <div className="connectet-content">
              ...
              <div className="connectetapps">
                <div className="connectetappsimg">
                  <div className="connectet-img">
                    <img src="/assets/admin/img/icons/user-edit.svg" alt="img" />
                  </div>
                  <div className="connectet-content">
