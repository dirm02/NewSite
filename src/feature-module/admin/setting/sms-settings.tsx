            ...
            <div className="row location-set">
              <div className="col-lg-4 col-sm-6 col-12">
                ...
                <div className="nav-menus">
                  <ImageWithBasePath src="assets/admin/img/company/nexmo.png" alt="img" />
              ...
              <div className="col-lg-4 col-sm-6 col-12">
                ...
                <div className="nav-menus">
                  <ImageWithBasePath src="assets/admin/img/company/2-factor.png" alt="img" />
                  <div className="settings-view">
                    <div className="active-switch">
                      <label className="switch">
                        <input type="checkbox" defaultChecked />
              ...
              <div className="col-lg-4 col-sm-6 col-12">
                ...
                <div className="nav-menus">
                  <ImageWithBasePath src="assets/admin/img/company/twilio.png" alt="img" />
                  <div className="settings-view">
                    <div className="active-switch">
                      <label className="switch">
                        <input type="checkbox" defaultChecked />
