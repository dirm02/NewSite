              ...
              <div className="row">
                  ...
                  <div className="upload-div">
                    ...
                    <div className="upload-img">
                      <div className="upload-imgset">
                        <ImageWithBasePath src="assets/admin/img/icons/gallery.svg" alt="img" id="blah" />
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-lg-12">
                  <div className="upload-div">
                    ...
                    <div className="upload-img">
                      <div className="upload-imgset">
                        <ImageWithBasePath src="assets/admin/img/icons/gallery.svg" alt="img" id="blahset" />
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-lg-12">
                  <div className="upload-div mb-0">
                    ...
                    <div className="upload-img">
                      <div className="upload-imgset">
                        <ImageWithBasePath src="assets/admin/img/icons/gallery.svg" alt="img" id="blah1" />
                      </div>
                    </div>
                  </div>
                </div>
