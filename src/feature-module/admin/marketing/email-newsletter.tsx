...
import type { NewslettersItem } from '../../../core/models/interface';
  ...
  const renderBody2 = () => {
    return (
      <div className="table-actions render-action d-flex">
        ...
        >
          <ImageWithBasePath src="assets/admin/img/icons/sms.svg" alt="svg" />
        </Link>
        <Link
        ...
        >
          <ImageWithBasePath src="assets/admin/img/icons/delete.svg" alt="svg" />
        </Link>
      </div>
    );
  };
