...
import type { Header } from '../../../../core/models/interface';
        ...
        <div className="container-fluid">
            ...
            <div className="offcanvas-wrap">
              <div className="offcanvas-detail">
                ...
                <div className="offcanvas__contact">
                  <div className="mt-4">
                    <Link to={all_routes.login} className="btn btn-light w-100 mb-2">
          ...
          <div className="header-nav">
            <div className="main-menu-wrapper">
                    ...
                    <div className="noti-content">
                      <div className="d-flex flex-column">
                        <div className="border-bottom mb-3 pb-3">
                          <a href={all_routes.customerLoginActivity}>
                        ...
                        <div className="border-bottom mb-3 pb-3">
                          <a href={all_routes.customerLoginActivity} className="pb-0">
                            <div className="d-flex">
                              <span className="avatar avatar-lg me-2 flex-shrink-0">
                                <ImageWithBasePath
              ...
              <a href={all_routes.register} className="btn btn-primary">
                <i className="ti ti-user-filled me-2" />
                Register
              </a>
              <div className="header__hamburger d-lg-none my-auto">
