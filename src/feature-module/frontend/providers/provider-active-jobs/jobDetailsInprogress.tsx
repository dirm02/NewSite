...
import { Status } from "../../../../core/data/json/dropDownData";
import CustomDropdown from "../../common/dropdown/commonSelect";

const JobDetailsInprogress = () => {
  return (
    <>
      <>
        {/* Page Wrapper */}
                    ...
                    <div className="card mb-0">
                      <div className="card-body">
                        <div className="border-bottom pb-3 mb-3">
                          <h3 className="custom-subtitle mb-0">
                            Project Overview
                          </h3>
                        </div>
                        <p className="fs-14 mb-4">
                          {" "}
                          We're looking for a skilled technician to provide
                          top-notch AC repair and maintenance services. The
                          ideal candidate should have experience in diagnosing
                          and fixing AC issues, a strong understanding of HVAC
                        ...
                        <div className="row g-3">
                          <div className="col-sm-6">
                            ...
                            >
                              <i className="isax isax-arrow-right5 me-2" />
                              Create Request
                            </Link>
                          </div>
                          <div className="col-sm-6">
                            ...
                            >
                              <i className="isax isax-close-circle5 me-2" />
                              Cancel Job
                            </Link>
                          </div>
                        </div>
                      ...
                      <div className="card-body">
                        ...
                        <ul className="timeline-list">
                          <li className="item d-flex justify-content-between flex-wrap pb-3">
                            ...
                            <p className="fs-13 text-dark mb-0 ps-4">-</p>
                          </li>
                          <li className="item d-flex justify-content-between flex-wrap pb-3">
                            <p className="fs-14 fw-semibold d-flex align-items-center text-dark mb-0">
      ...
      {/* Message */}
      <div className="modal fade custom-modal" id="message">
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-header d-flex align-items-center justify-content-between">
              <h4 className="fs-20 fw-semibold mb-0">Message</h4>
              <Link
              ...
              <div className="modal-body">
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <div className="mb-0">
                      <div className="bg-light-500 rounded p-2 d-flex align-items-center gap-2">
                        <div>
                          <i className="isax isax-image fs-24" />
                        </div>
                        <div>
                          <p className="fs-14 text-dark mb-1">Photo_2324.jpg</p>
                          <p className="fs-14 mb-0 text-muted">4.2 MB</p>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <div className="modal-dialog modal-md modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-body text-center p-5">
              ...
              <h4 className="mb-3">Are you sure to cancel the order?</h4>
              <p className="mb-4">
                Cancelling this order will stop the service request and may
                remove any scheduled appointments associated with it.
              </p>
...
export default JobDetailsInprogress;
