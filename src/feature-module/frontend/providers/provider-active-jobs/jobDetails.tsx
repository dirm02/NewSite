...
const JobDetails = () => {
  return (
    <>
                      ...
                      <div className="d-flex justify-content-between align-items-center flex-wrap gap-3">
                        <div className="d-flex align-items-center flex-wrap gap-3">
                          ...
                          <div>
                            ...
                            <h2 className="custom-subtitle mb-0 fs-16 fw-semibold">
                  ...
                  <div className="card mb-0">
                    <div className="card-body">
                      ...
                      <p className="fs-14 mb-4">
                        ...
                        top-notch AC repair and maintenance services. The ideal
                        candidate should have experience in diagnosing and
                        fixing AC issues, a strong understanding of HVAC
      ...
      <>
        {/* Submit Details */}
        <div className="modal fade custom-modal" id="cancel-order">
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              <div className="modal-body p-4">
                <div className="text-center">
                  <div className="custom-success custom-danger">
                    <span className="d-flex align-items-center justify-content-center fs-40 text-danger mb-3">
                      <i className="isax isax-close-circle5" />
                    </span>
                  </div>
                  <p className="fs-24 mb-1 fw-semibold text-dark">
                    Are you sure to cancel the order?
                  </p>
                  <p className="mb-4 text-muted">
                    Cancelling this order will stop the service request and may{" "}
                    <br /> remove any scheduled appointments associated with it.
                  </p>
