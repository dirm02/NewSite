          ...
          <div className="card">
            <div className="card-body">
              <div className="d-flex align-items-center pb-2 border-bottom mb-3">
                <Link
                  to={routes.providerCustomerDetails}
                ...
                <div>
                  <h6 className="fs-14">
                    <Link to={routes.providerCustomerDetails}>Anthony Lewis</Link>
                  </h6>
          ...
          <div className="card">
            <div className="card-body">
              <div className="d-flex align-items-center pb-2 border-bottom mb-3">
                ...
                <div>
                  <h6 className="fs-14">
                    <Link to={routes.providerCustomerDetails}>Brian Villalobos</Link>
                  </h6>
          ...
          <div className="card">
            <div className="card-body">
              <div className="d-flex align-items-center pb-2 border-bottom mb-3">
                ...
                <div>
                  <h6 className="fs-14">
                    <Link to={routes.providerCustomerDetails}>Harvey Smith</Link>
                  </h6>
          ...
          <div className="card">
            <div className="card-body">
              <div className="d-flex align-items-center pb-2 border-bottom mb-3">
                ...
                <div>
                  <h6 className="fs-14">
                    <Link to={routes.providerCustomerDetails}>Stephan Peralt</Link>
                  </h6>
          ...
          <div className="card">
            <div className="card-body">
              <div className="d-flex align-items-center pb-2 border-bottom mb-3">
                ...
                <div>
                  <h6 className="fs-14">
                    <Link to={routes.providerCustomerDetails}>Doglas Martini</Link>
                  </h6>
          ...
          <div className="card">
            <div className="card-body">
              <div className="d-flex align-items-center pb-2 border-bottom mb-3">
                ...
                <div>
                  <h6 className="fs-14">
                    <Link to={routes.providerCustomerDetails}>Linda Ray</Link>
                  </h6>
          ...
          <div className="card">
            <div className="card-body">
              <div className="d-flex align-items-center pb-2 border-bottom mb-3">
                ...
                <div>
                  <h6 className="fs-14">
                    <Link to={routes.providerCustomerDetails}>Elliot Murray</Link>
                  </h6>
                  <span className="fs-12">anthony@example.com</span>
                </div>
              </div>
...
export default ProviderCustomerGrid