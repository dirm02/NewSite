                  ...
                  <div className="pass-group">
                    ...
                    <span
                      ...
                      className={`toggle-password feather ${
                        selectedItems[1] ? "icon-eye" : "icon-eye-off"
                      }`}
                    />
                  </div>
                </div>
                <div className="mb-3">
                  ...
                  <div className="pass-group" id="passwordInput">
                    ...
                    <span
                      ...
                      className={`toggle-password feather ${
                        selectedItems[2] ? "icon-eye" : "icon-eye-off"
                      }`}
                    />
                  </div>
                ...
                <div className="mb-3">
                  ...
                  <div className="pass-group">
                    ...
                    <span
                      ...
                      className={`toggle-password feather ${
                        selectedItems[3] ? "icon-eye" : "icon-eye-off"
                      }`}
                    />
                  </div>
                </div>
                  ...
                  <div className="mb-3">
                    ...
                    <div className="pass-group">
                      ...
                      <span
                        ...
                        className={`toggle-password feather ${
                          selectedItems[4] ? "icon-eye" : "icon-eye-off"
                        }`}
                      />
                    </div>
                  </div>
                  ...
                  <div className="mb-3">
                    ...
                    <div className="pass-group">
                      ...
                      <span
                        ...
                        className={`toggle-password feather ${
                          selectedItems[5] ? "icon-eye" : "icon-eye-off"
                        }`}
                      />
                    </div>
                  </div>
