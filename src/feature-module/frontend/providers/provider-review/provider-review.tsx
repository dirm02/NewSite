            ...
            <div className="col-xxl-12 col-lg-12">
              <div className="card shadow-none">
                <div className="card-body">
                  ...
                  <div>
                    <p className="fs-14">
                      The construction service delivered excellent
                      craftsmanship, completing my home renovation on time with
                      clear communication throughout. Highly recommend for
            ...
            <div className="col-xxl-12 col-lg-12">
              <div className="card shadow-none">
                <div className="card-body">
                  ...
                  <div>
                    <p className="fs-14">
                      The commercial painting service provided outstanding
                      results, with precise attention to detail and timely
                      completion. Their professionalism and quality of work are
                      top-notch!
                    </p>
                  </div>
                </div>
                ...
                <div className="card-body">
                  ...
                  <div>
                    <p className="fs-14">
                      ...
                      They completed the project on time, and the final results
            ...
            <div className="col-xxl-12 col-lg-12">
              <div className="card shadow-none">
                <div className="card-body">
                  ...
                  <div>
                    <p className="fs-14">
                      The air conditioning service was excellent, with prompt
                      and thorough maintenance that restored my system to peak
                ...
                <div className="card-body">
                  ...
                  <div>
                    <p className="fs-14">
                      ...
                      delivering precise installation with high-quality
                      materials. Their attention to detail and professionalism
                      ensured a flawless finish and timely completion.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="col-xxl-12 col-lg-12">
              <div className="card shadow-none">
                <div className="card-body">
                  ...
                  <div>
                    <p className="fs-14">
                      The car repair service was exceptional, providing prompt
                      and thorough repairs with clear communication throughout.
                      Their expertise and attention to detail restored my
