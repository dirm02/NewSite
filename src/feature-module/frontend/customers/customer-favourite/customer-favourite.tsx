                ...
                <div className="card-body p-0">
                  <div className="img-sec-2 w-100">
                    ...
                    <div className="image-tag d-flex justify-content-end align-items-center">
                      ...
                      >
                        <i
                          className={`ti ti-heart-filled  ${selectedItems[1] ? "filled" : ""}`}
                        />
                      </Link>
                ...
                <div className="card-body p-0">
                  <div className="img-sec-2">
                    ...
                    <div className="image-tag d-flex justify-content-end align-items-center">
                      ...
                      >
                        <i
                          className={`ti ti-heart-filled  ${selectedItems[2] ? "filled" : ""}`}
                        />
                      </Link>
                ...
                <div className="card-body p-0">
                  <div className="img-sec-2 w-100">
                    ...
                    <div className="image-tag d-flex justify-content-end align-items-center">
                      ...
                      >
                        <i
                          className={`ti ti-heart-filled  ${selectedItems[3] ? "filled" : ""}`}
                        />
                      </Link>
                      <span className="trend-tag-2">Construction</span>
                    </div>
                ...
                <div className="card-body p-0">
                  <div className="img-sec-2 w-100">
                    ...
                    <div className="image-tag d-flex justify-content-end align-items-center">
                      ...
                      >
                        <i
                          className={`ti ti-heart-filled  ${selectedItems[4] ? "filled" : ""}`}
                        />
                      </Link>
                ...
                <div className="card-body p-0">
                  <div className="img-sec-2 w-100">
                    ...
                    <div className="image-tag d-flex justify-content-end align-items-center">
                      ...
                      >
                        <i
                          className={`ti ti-heart-filled  ${selectedItems[5] ? "filled" : ""}`}
                        />
                      </Link>
                      <span className="trend-tag-2">Car Wash</span>
                    </div>
                ...
                <div className="card-body p-0">
                  <div className="img-sec-2 w-100">
                    ...
                    <div className="image-tag d-flex justify-content-end align-items-center">
                      ...
                      >
                        <i
                          className={`ti ti-heart-filled  ${selectedItems[6] ? "filled" : ""}`}
                        />
                      </Link>
                ...
                <div className="card-body p-0">
                  <div className="img-sec-2 w-100">
                    ...
                    <div className="image-tag d-flex justify-content-end align-items-center">
                      ...
                      >
                        <i
                          className={`ti ti-heart-filled  ${selectedItems[7] ? "filled" : ""}`}
                        />
                      </Link>
                ...
                <div className="card-body p-0">
                  <div className="img-sec-2 w-100">
                    ...
                    <div className="image-tag d-flex justify-content-end align-items-center">
                      ...
                      >
                        <i
                          className={`ti ti-heart-filled  ${selectedItems[8] ? "filled" : ""}`}
                        />
                      </Link>
                ...
                <div className="card-body p-0">
                  <div className="img-sec-2 w-100">
                    ...
                    <div className="image-tag d-flex justify-content-end align-items-center">
                      ...
                      >
                        <i
                          className={`ti ti-heart-filled  ${selectedItems[9] ? "filled" : ""}`}
                        />
                      </Link>
                      <span className="trend-tag-2">Construction</span>
                    </div>
