                  ...
                  <tr>
                    <td>
                      <div className="notify-item">
                        <h6 className="mb-1">
                          General Notifications Newsletter
                        </h6>
                        <p>
                  ...
                  <tr>
                    <td>
                      <div className="notify-item">
                        ...
                        <p>
                          Receive updates on your refund request status
                          instantly.
                        </p>
                      </div>
                    </td>
                  ...
                  <tr>
                    <td>
                      <div className="notify-item">
                        ...
                        <p>
                          Stay updated with notifications about your
                          subscription.
                        </p>
                      </div>
                    </td>
                  ...
                  <tr>
                    <td>
                      <div className="notify-item">
                        ...
                        <p>
                          Get notifications for all wallet transactions and
                          updates.
                        </p>
                      </div>
                    </td>
