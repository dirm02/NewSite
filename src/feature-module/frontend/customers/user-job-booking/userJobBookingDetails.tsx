...
const UserJobBookingDetails = () => {
  return (
    <>
      {/* Page Wrapper */}
      <div className="page-wrapper">
        <div className="content container-fluid">
          <h2 className="mb-4 fs-14">
            <Link
                ...
                <div className="card-body">
                  ...
                  <div className="d-flex align-items-center justify-content-between gap-3 mb-3 flex-wrap">
                    <div className="d-flex align-items-center gap-3 flex-wrap">
                      <div className="avatar avatar-xxl rounded overflow-hidden flex-shrink-0">
                        <ImageWithBasePath
                      ...
                      <div className="flex-grow-1">
                        <h3 className="mb-2 fs-20 fw-semibold">
                    ...
                    <div className="text-sm-end text-start">
                      ...
                      <h4 className="mb-0 fs-18 fw-semibold text-secondary">
                        $750
                      </h4>
                    </div>
                  </div>
                  <p className="mb-3 fs-14 ">
                    Seeking a certified HVAC Technician to manage climate
                    control systems for our clients. The ideal candidate will
                    have a solid background in HVAC technology, excellent
                    diagnostic abilities, and a dedication to superior customer
                    satisfaction.
                  </p>
                  ...
                  <div className="d-flex align-items-center justify-content-between gap-3 flex-wrap">
                    <div className="d-flex align-items-center gap-2 flex-wrap">
                      <Link
                        ...
                        data-bs-target="#completed-work"
                      >
                        <i className="isax isax-messages-3" /> Mark as Done{" "}
                      </Link>
                      <Link
                        to="#"
                        className="btn btn-outline-white d-inline-flex align-items-center gap-2"
                      >
                        <i className="isax isax-message" /> Message Seller{" "}
                      </Link>
                    </div>
                    <Link
                      to="#"
            ...
            <div className="col-lg-4">
              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <div className="mb-4">
                    <div className="mb-2 fs-14 fw-semibold text-dark">
                      Skills
                    </div>
                ...
                <div className="card-body">
                  <div className="card-header pt-0 px-0 mb-4">
                    <div className="d-flex align-items-center justify-content-between gap-2 flex-wrap">
                      ...
                      <span className="badge border border-purple text-purple d-inline-flex align-items-center gap-1">
                        <i className="fa-solid fa-circle fs-6" />
                        Pending
                      </span>
                    </div>
              ...
              <div className="card bg-info mb-0 overflow-hidden">
                <div className="card-body">
                  ...
                  <p className="mb-4 fs-14 text-white position-relative z-1">
                    If you're experiencing issues with this job, our support
...
export default UserJobBookingDetails;
