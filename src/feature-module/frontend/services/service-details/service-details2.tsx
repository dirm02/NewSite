...
const ServiceDetails2 = () => {
  ...
  const tabs = [
    ...
    { id: "service-offered", label: "Services Offered" },
    { id: "service-includes", label: "Includes & Excludes" },
    { id: "service-gallery", label: "Gallery" },
    { id: "service-video", label: "Video" },
    { id: "service-faq", label: "FAQ’s" },
  ];
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      tabs.forEach((tab) => {
        ...
        if (element) {
          const sectionTop = element.offsetTop - 100; // Adjust offset as needed
    ...
    // Add initial check in case page loads with hash
    handleScroll();
                ...
                <div className="card border-0">
                  <div className="card-body">
                    ...
                    <div className="service-wrap vertical-slider">
                      ...
                      <Slider
                        {...settings2}
                        className="slider-nav slide-small nav-center"
                      >
                        <ImageWithBasePath
                            ...
                            <div className="offer-item d-md-flex align-items-center justify-content-between bg-white mb-2">
                              <div className="d-sm-flex align-items-center mb-2">
                                ...
                                <div className="mb-2">
                                  ...
                                  <p className="fs-14">
                                    Fixing faulty wiring, outlets, switches, and
                                    more to ensure.
                                  </p>
                                </div>
                              </div>
