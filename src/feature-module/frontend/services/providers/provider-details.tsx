...
const ProviderDetails = () => {
  ...
  return (
    <>
      <HomeHeader type={2} />
      <BreadCrumb title="Provider Details" item1="Provider Details" />
                    ...
                    >
                        ...
                        >
                          <div className="accordion-body p-0 mt-3 pb-1">
                            <div className="more-text">
                              <p className="mb-4">
                                We bring over 20 years of expertise to your
                                doorstep, offering a full range of electrical
                                services tailored to meet the needs of
                                homeowners, businesses, and industrial clients.
                                Our commitment to safety, reliability, and
                                customer satisfaction has made us a trusted name
                                in the industry. Whether you&apos;re in need of
                                a simple repair or a complex installation, our
                                team of certified electricians is here to help.
                              </p>
                              <p>
                                we bring over 20 years of expertise to your
                                doorstep, offering a full range of electrical
                      ...
                      <div className="accordion-item mb-3">
                        ...
                        >
                          <div className="accordion-body p-0 mt-3 pb-1">
                            <p>
                              From small residential repairs to large-scale
                              commercial and industrial projects, is your go-to
                              provider for all electrical needs. Contact us
                              today to schedule a consultation or to learn more
                              about how we can assist with your next project.
                            </p>
                            <div>
                              <div className="row g-3">
                                <div className="col-xl-12">
                                  <Slider
                                    {...two}
                                    className="area-expert-slider reactslick owl-carousel mb-3"
                                  >
                          ...
                          <div className="accordion-body p-0 mt-3 pb-1">
                            <div className="row">
                              <div className="col-md-12">
                                <Slider
                                  {...one}
                                  className="our-services-slider reactslick custom-owl-dot owl-carousel"
                                >
                                  <div className="card">
                                    <div className="card-body">
                      ...
                      <div className="accordion-item mb-3">
                        ...
                        >
                          <div className="accordion-body p-0 mt-3 pb-1">
                            <Slider
                              {...three}
                              className="our-branches-slider reactslick owl-carousel custom-owl-dot"
                            >
